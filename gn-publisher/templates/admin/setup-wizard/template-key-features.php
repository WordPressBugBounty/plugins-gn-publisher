...
$gnpub_news_chk_box 					=	isset( $gnpub_checklist_options['gnpub_enable_news_article_schema'] ) ? $gnpub_checklist_options['gnpub_enable_news_article_schema']: false;
...
$gnpub_fimage_chk_box 				=	isset( $gnpub_checklist_options['gnpub_show_info_featured_img'] ) ? $gnpub_checklist_options['gnpub_show_info_featured_img']: false;
$gnpub_fimage_chk_box_class 			=	'gnpub-setup-wizard-chklist-td ';
$gnpub_fimage_chk_box_op_class 		=	'gnpub-setup-wizard-add-opacity ';
if ( $gnpub_fimage_chk_box == true ) {
	$gnpub_fimage_chk_box_class 		.= 	'gnpub-setup-wizard-chklist-tr-checked';		
	$gnpub_fimage_chk_box_op_class 	.= 	'gnpub-setup-wizard-chklist-opacity';		
}
?>
<header>
	...
	<table class="form-table gnpub-setup-wizard-form-table">
		<tbody>
			<tr class="gnpub-setup-wizard-chklist-tr">
				<th class="<?php echo esc_attr( $gnpub_news_chk_box_op_class ); ?>" data-hide="gnpub_enable_news_article_schema">
				...
				<td class="<?php echo esc_attr( $gnpub_news_chk_box_op_class ); ?>" data-hide="gnpub_enable_news_article_schema">
		        ...
		        <td class="<?php echo esc_attr( $gnpub_news_chk_box_class ); ?>">
		        	<input class="gnpub-setup-wizard-chklist-chkbox" type="checkbox" name="gnpub_setup_wizard_checklist[gnpub_enable_news_article_schema]" <?php checked( $gnpub_news_chk_box, true ); ?> value="1" data-dont-hide="gnpub_enable_news_article_schema" data-chk-opt-name="gnpub_enable_news_article_schema" />
		        </td>
			</tr>
			<tr class="gnpub-setup-wizard-chklist-tr">
        		<th class="<?php echo esc_attr( $gnpub_fimage_chk_box_op_class ); ?>" data-hide="gnpub_show_info_featured_img">
        		...
        		<td class="<?php echo esc_attr( $gnpub_fimage_chk_box_op_class ); ?>" data-hide="gnpub_show_info_featured_img">
		        ...
		        <td class="<?php echo esc_attr( $gnpub_fimage_chk_box_class ); ?>">
		        	<input class="gnpub-setup-wizard-chklist-chkbox" type="checkbox" name="gnpub_setup_wizard_checklist[gnpub_show_info_featured_img]" <?php checked( $gnpub_fimage_chk_box, true ); ?> value="1" data-dont-hide="gnpub_show_info_featured_img" data-chk-opt-name="gnpub_show_info_featured_img" />
		        </td>
        	</tr>
		</tbody>
